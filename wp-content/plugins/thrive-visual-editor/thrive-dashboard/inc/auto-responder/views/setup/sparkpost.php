...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label
				for="tvd-mg-api-domain"><?php echo __( "SparkPost-verified email", TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		<div class="tvd-input-field">
...
<div class="tvd-row">
	<div class="tvd-col tvd-12">
		<p class="tve-form-description tvd-note-text">
			<?php echo __( 'Note: Sending through SparkPost only works if your domain name has been set and verified within your SparkPost account. You can use "testing@sparkpostbox.com" as verified email to test your application while waiting for your own to be verified.', TVE_DASH_TRANSLATE_DOMAIN ) ?>
