...
<div id="consentAskBox" style="display: none;">
  ...
  <div class=" popb_button nope_buton button">No, Thank you</div>
  <div style="float: right; margin: 20px;">
    ...
    <div class="expaned_info" style="display: none;">
      ...
      <ul>
          ...
          <li>Number Of Landing Pages Built</li>
      </ul>
      <h4>Tracking</h4>
      <ul>
	...
	<div class="pluginops-tabs">
      ...
      <div id="tab2" class="pluginops-tab" style="background: #F3F6F8;">
        ...
        <div class="video-card">
          <iframe width="460" height="255" src="https://www.youtube.com/embed/3JhSAYRfmAM" frameborder="0" allowfullscreen></iframe>
          <h3>Quick Tour</h3>
        </div>
        ...
        <div class="video-card">
          ...
          <h3>How to change landingpage URL keyword.</h3>
        </div>
...
<style type="text/css">
  ...
  .yes_buton{
    ...
    padding: 6px 30px 1px !important;
  }
  .nope_buton{
    float: right;
  }
...
<script type="text/javascript">
    ...
    jQuery('.close_data_optin').click(function(){
      jQuery('#consentAskBox').css('display','none');
      e.preventDefault();
    });

    jQuery('.expand_collection_information').click(function(){
      jQuery('.expaned_info').css('display','block');
      e.preventDefault();
    });

    jQuery('.popb_button').click(function(){
