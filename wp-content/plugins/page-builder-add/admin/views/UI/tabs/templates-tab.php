    ...
    <div id="tab2" class="pluginops-tab">
      ...
      <div style="float: left; margin: 10px 30px; font-size: 18px; color: #7d7d7d;">
            ...
            <div class="pluginops-tab2-content">
              <div id="landingpages" class="pluginops-tab2 active">
                ...
                <div id="column-1" class="col">
                  ...
                  <div id="card" class="temp-prev-0 card tempPaca template-card">
                          <div id="temp-prev-0" class="tempPrev tempPaca"> <p id="temp-prev-0"><b>Preview</b></p></div>
                          <label for="temp-0"> <img src="<?php echo $pbPP_imgFolderURL.'template-0.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-0.png" class='card-img temp-prev-0'>
                          ...
                          <label for="temp-0"><strike> Select </strike> <b>Pro Only</b> </label>
                  ...
                  <div id="card" class="temp-prev-85 card tempPaca template-card">
                          ...
                          <label for="temp-85"> <img src="<?php echo $pbPP_imgFolderURL.'template-85.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-85.png" class='card-img temp-prev-85'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-85' name="template_select" value='temp85'>
                          <label for="temp-85"><strike> Select </strike> <b>Pro Only</b> </label>
                  ...
                  <div id="card" class="temp-prev-84 card tempPaca template-card">
                          ...
                          <label for="temp-84"> <img src="<?php echo $pbPP_imgFolderURL.'template-84.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-84.png" class='card-img temp-prev-84'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-84' name="template_select" value='temp84'>
                          <label for="temp-84"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-83 card tempPaca template-card">
                          ...
                          <label for="temp-83"> <img src="<?php echo $pbPP_imgFolderURL.'template-83.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-83.png" class='card-img temp-prev-83'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-83' name="template_select" value='temp83'>
                          <label for="temp-83"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-78 card tempPaca template-card">
                          ...
                          <label for="temp-78"> <img src="<?php echo $pbPP_imgFolderURL.'template-78.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-78.png" class='card-img temp-prev-78'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-78' name="template_select" value='temp78'>
                          <label for="temp-78"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-77 card tempPaca template-card">
                          ...
                          <label for="temp-77"> <img src="<?php echo $pbPP_imgFolderURL.'template-77.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-77.png" class='card-img temp-prev-77'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-77' name="template_select" value='temp77'>
                          <label for="temp-77"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-82 card tempPaca template-card">
                          ...
                          <label for="temp-82"> <img src="<?php echo $pbPP_imgFolderURL.'template-82.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-82.png" class='card-img temp-prev-82'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-82' name="template_select" value='temp82'>
                          <label for="temp-82"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-86 card tempPaca template-card">
                          ...
                          <label for="temp-86"> <img src="<?php echo $pbPP_imgFolderURL.'template-86.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-86.png" class='card-img temp-prev-86'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-86' name="template_select" value='temp86'>
                          <label for="temp-86"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-68 card tempPaca template-card">
                          ...
                          <label for="temp-68"> <img src="<?php echo $pbPP_imgFolderURL.'template-68.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-68.png" class='card-img temp-prev-68'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-68' name="template_select" value='temp68'>
                          <label for="temp-68"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-80 card tempPaca template-card">
                          ...
                          <label for="temp-80"> <img src="<?php echo $pbPP_imgFolderURL.'template-80.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-80.png" class='card-img temp-prev-80'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-80' name="template_select" value='temp80'>
                          <label for="temp-80"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-66 card tempPaca template-card">
                          ...
                          <label for="temp-66"> <img src="<?php echo $pbPP_imgFolderURL.'template-66.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-66.png" class='card-img temp-prev-66'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-66' name="template_select" value='temp66'>
                          <label for="temp-66"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-65 card tempPaca template-card">
                          ...
                          <label for="temp-65"> <img src="<?php echo $pbPP_imgFolderURL.'template-65.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-65.png" class='card-img temp-prev-65'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-65' name="template_select" value='temp65'>
                          <label for="temp-65"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-64 card tempPaca template-card">
                          ...
                          <label for="temp-64"> <img src="<?php echo $pbPP_imgFolderURL.'template-64.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-64.png" class='card-img temp-prev-64'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-64' name="template_select" value='temp64'>
                          <label for="temp-64"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-62 card tempPaca template-card">
                          ...
                          <label for="temp-62"> <img src="<?php echo $pbPP_imgFolderURL.'template-62.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-62.png" class='card-img temp-prev-62'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-62' name="template_select" value='temp62'>
                          <label for="temp-62"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-76 card tempPaca template-card">
                          ...
                          <label for="temp-76"> <img src="<?php echo $pbPP_imgFolderURL.'template-76.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-76.png" class='card-img temp-prev-76'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-76' name="template_select" value='temp76'>
                          <label for="temp-76"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-81 card tempPaca template-card">
                          ...
                          <label for="temp-81"> <img src="<?php echo $pbPP_imgFolderURL.'template-81.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-81.png" class='card-img temp-prev-81'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-81' name="template_select" value='temp81'>
                          <label for="temp-81"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-75 card tempPaca template-card">
                          ...
                          <label for="temp-75"> <img src="<?php echo $pbPP_imgFolderURL.'template-75.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-75.png" class='card-img temp-prev-75'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-75' name="template_select" value='temp75'>
                          <label for="temp-75"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-79 card tempPaca template-card">
                          ...
                          <label for="temp-79"> <img src="<?php echo $pbPP_imgFolderURL.'template-79.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-79.png" class='card-img temp-prev-79'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-79' name="template_select" value='temp79'>
                          <label for="temp-79"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-63 card tempPaca template-card">
                          ...
                          <label for="temp-63"> <img src="<?php echo $pbPP_imgFolderURL.'template-63.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-63.png" class='card-img temp-prev-63'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-63' name="template_select" value='temp63'>
                          <label for="temp-63"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-61 card tempPaca template-card">
                          ...
                          <label for="temp-61"> <img src="<?php echo $pbPP_imgFolderURL.'template-61.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-61.png" class='card-img temp-prev-61'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-61' name="template_select" value='temp61'>
                          <label for="temp-61"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                  ...
                  <div id="card" class="temp-prev-60 card tempPaca template-card">
                          ...
                          <label for="temp-60"> <img src="<?php echo $pbPP_imgFolderURL.'template-60.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-60.png" class='card-img temp-prev-60'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-60' name="template_select" value='temp60'>
                          <label for="temp-60"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-59 card tempPaca template-card">
                          ...
                          <label for="temp-59"> <img src="<?php echo $pbPP_imgFolderURL.'template-59.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-59.png" class='card-img temp-prev-59'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-59' name="template_select" value='temp59'>
                          <label for="temp-59"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-58 card tempPaca template-card">
                          ...
                          <label for="temp-58"> <img src="<?php echo $pbPP_imgFolderURL.'template-58.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-58.png" class='card-img temp-prev-58'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-58' name="template_select" value='temp58'>
                          <label for="temp-58"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-67 card tempPaca template-card">
                          ...
                          <label for="temp-67"> <img src="<?php echo $pbPP_imgFolderURL.'template-67.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-67.png" class='card-img temp-prev-67'>
                          <p class="card-desc"></p> </label>
                          <input type="radio" disabled="disabled" class="template_select" id='temp-67' name="template_select" value='temp67'>
                          <label for="temp-67"><strike> Select </strike> <b>Pro Only</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-69 card tempPaca template-card">
                      ...
                      <label for="temp-69"> <img src="<?php echo $pbPP_imgFolderURL.'template-69.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-69.png" class='card-img temp-prev-69'>
                      <p class="card-desc"></p> </label>
                      <input type="radio" disabled="disabled" class="template_select" id='temp-69' name="template_select" value='temp69'>
                      <label for="temp-69"><strike> Select </strike> <b>Pro Only</b> </label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-72 card tempPaca template-card">
                      ...
                      <label for="temp-72"> <img src="<?php echo $pbPP_imgFolderURL.'template-72.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-72.png" class='card-img temp-prev-72'>
                      <p class="card-desc"></p> </label>
                      <input type="radio" disabled="disabled" class="template_select" id='temp-72' name="template_select" value='temp72'>
                      <label for="temp-72"><strike> Select </strike> <b>Pro Only</b> </label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-74 card tempPaca template-card">
                      ...
                      <label for="temp-74"> <img src="<?php echo $pbPP_imgFolderURL.'template-74.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-74.png" class='card-img temp-prev-74'>
                      <p class="card-desc"></p> </label>
                      <input type="radio" disabled="disabled" class="template_select" id='temp-74' name="template_select" value='temp74'>
                      <label for="temp-74"><strike> Select </strike> <b>Pro Only</b> </label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-73 card tempPaca template-card">
                      ...
                      <label for="temp-73"> <img src="<?php echo $pbPP_imgFolderURL.'template-73.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-73.png" class='card-img temp-prev-73'>
                      <p class="card-desc"></p> </label>
                      <input type="radio" disabled="disabled" class="template_select" id='temp-73' name="template_select" value='temp73'>
                      <label for="temp-73"><strike> Select </strike> <b>Pro Only</b> </label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-70 card tempPaca template-card">
                      ...
                      <label for="temp-70"> <img src="<?php echo $pbPP_imgFolderURL.'template-70.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-70.png" class='card-img temp-prev-70'>
                      <p class="card-desc"></p> </label>
                      <input type="radio" disabled="disabled" class="template_select" id='temp-70' name="template_select" value='temp70'>
                      <label for="temp-70"><strike> Select </strike> <b>Pro Only</b> </label>
                      <span class="temp-cats-displayed">Click Through</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-71 card tempPaca template-card">
                      ...
                      <label for="temp-71"> <img src="<?php echo $pbPP_imgFolderURL.'template-71.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-71.png" class='card-img temp-prev-71'>
                      <p class="card-desc"></p> </label>
                      <input type="radio" disabled="disabled" class="template_select" id='temp-71' name="template_select" value='temp71'>
                      <label for="temp-71"><strike> Select </strike> <b>Pro Only</b> </label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-57 card tempPaca template-card">
                    ...
                    <label for="temp-57"> <img src="<?php echo $pbPP_imgFolderURL.'template-57.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-57.png" class='card-img temp-prev-57'>
                    <p class="card-desc"></p> </label>
                    <input type="radio" disabled="disabled" class="template_select" id='temp-57' name="template_select" value='temp57'>
                    <label for="temp-57"><strike> Select </strike> <b>Pro Only</b> </label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-56 card tempPaca template-card">
                    ...
                    <label for="temp-56"> <img src="<?php echo $pbPP_imgFolderURL.'template-56.png'; ?>" data-img_src="https://ps.w.org/page-builder-add/assets/screenshot-56.png" class='card-img temp-prev-56'>
                    <p class="card-desc"></p> </label>
                    <input type="radio" disabled="disabled" class="template_select" id='temp-56' name="template_select" value='temp56'>
                    <label for="temp-56"><strike> Select </strike> <b>Pro Only</b> </label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
