  ...
  <div class="edit_options_left_row">
      ...
      <div class="pluginops-tabs2">
        <ul class="pluginops-tab2-links">
          ...
          <li style="margin: 0;"><a style="font-size:12px; padding: 10px; text-align: center;" href="#tabCustomCss" class="pluginops-tab2_link"> <i class="fa fa-code" style="font-size: 20px;"></i> <br> Custom CSS & JS</a></li>
        </ul>
          ...
          <div id="tabPageOptions" class="pluginops-tab2 active" style="min-height:400px;">
            <div class="pluginops-tabs2">
              ...
              <div class="pluginops-tab2-content" style="overflow: hidden; background: #fff;">
                ...
                <div id="PocustomFontstab" class="pluginops-tab2">
                  <div class="pbp_form" style="min-height: 400px; width: 93%;">
                    <div class="btn add_new_custom_font" > <span class="dashicons dashicons-plus-alt"></span> Add Font </div>
                    <br>
                    <br>
                    <br>
                    <ul class="sortableAccordionWidget  customFontsItems"></ul>
                    <br><br><br><br><hr><br>
                    <script type="text/javascript">
                      ...
                      (function($){
                          ...
                          jQuery('.add_new_custom_font').click(function(){
                              var index = $(".customFontsItems li").length;
                              ...
                              jQuery('.customFontsItems').append('<li>'+
                                  ' <h3 class="handleHeader"> Custom Font <span class="dashicons dashicons-trash customfontRemoveBtn" style="float: right;"></span> </h3>'+
                                  '<div class="accordContentHolder" style="background: #fff;"> '+
                                      '<label>Font Name</label>'+
                                      '<input type="text" class="poCfName">'+
                                      '<br><br><hr><br>'+
                                      "<p>Select Font files </p>"+
                                      '<label> Format EOT : </label>'+
                                      '<input id="image_location'+cfontCountA+'" type="text" class="poCfFileUrlEot upload_image_button'+cfontCountA+'"  name="lpp_add_img_'+cfontCountA+'" value=""  placeholder="Insert URL here" style="width:40%;" />'+
                                      ...
                                      '<input id="image_location'+cfontCountB+'" type="text" class="poCfFileUrlOtf upload_image_button'+cfontCountB+'"  name="lpp_add_img_'+cfontCountB+'" value=""  placeholder="Insert URL here" style="width:40%;" />'+
                                      ...
                                      '<input id="image_location'+cfontCountC+'" type="text" class="poCfFileUrlWoff upload_image_button'+cfontCountC+'"  name="lpp_add_img_'+cfontCountC+'" value=""  placeholder="Insert URL here" style="width:40%;" />'+
                                      ...
                                      '<input id="image_location'+cfontCountD+'" type="text" class="poCfFileUrlSvg upload_image_button'+cfontCountD+'"  name="lpp_add_img_'+cfontCountD+'" value=""  placeholder="Insert URL here" style="width:40%;" />'+
                          ...
                          $(document).on( 'change','.poCfName', function(){
                            
                              if ($(this).val() == '') {
                                  
                              } else{
                                  $(this).parent().siblings('.handleHeader').html($(this).val() + '<span class="dashicons dashicons-trash customfontRemoveBtn" style="float: right;"></span>');
                              }
                          });
                            ...
                            <?php
                                ...
                                if($proWidgetLoaded == false) {
                                    ?>
                                      ...
                                      <br><br><br><br><br><hr><br> <a href="https://pluginops.com/page-builder/?ref=widgets" class="premiumNoticeWidget" target="_blank" style="padding:5px 10px; text-decoration: none; font-size: 17px; text-align: center; color: #fff; background:#8BC34A; border-radius: 3px;"> Unlock All These Amazing Widgets </a> <br>
                                    <?php
                                }
                            ?> 
