...
<div class="lpp_modal popb_install_template_library">
  <div class="popb_confirm_container">
    ...
    <h2 class="popb_confirm_message">Template Library Required</h2><br>
    <h4 class="popb_confirm_subMessage">Please install template library by clicking on link below and then reload.</h4>
    <a class="installTemplateLibraryLink confirm_btn" style="background: #3F51B5; width:220px;"  href="<?php echo $tempslib_install_link; ?>"data-size="large" target="_blank">
      Install Template Library 
    </a>
    <p style="font-size:12; color:#777;">If template library is installed and this message is still appearing please contact us at support@pluginops.com </p>
  </div>
</div>
