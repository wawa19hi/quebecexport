...
<div class="pbp_form" style=" background: #fff; padding:20px 10px 20px 25px; width: 99%;">
    <label for="ftr-menu-style-1" style="width: 90%;"> Style 1
        <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-1.png'; ?>" class='menu-select'> </label>
    ...
    <label for="ftr-menu-style-2" style="width: 90%;"> Style 2 (Sticky)
        <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-2.png'; ?>" class='menu-select'> </label>
    ...
    <label for="ftr-menu-style-4" style="width: 90%;"> Style 3
        <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-4.png'; ?>" class='menu-select'> </label>
    ...
    <label for="ftr-menu-style-3" style="width: 99%;"> Style 4 (Without Logo)
        <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-3.png'; ?>" class='menu-select'> </label>
