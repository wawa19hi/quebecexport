...
<div class="pluginops-tab2-content" style="box-shadow:none;">
	<div id="pricing_cf1" class="pluginops-tab2 active" style="width: 99%;">
        <br>
        <br>
        ...
        <textarea  id="pbPricingContent"  class="pbPricingContent" data-optname='pbPricingContent' name="pbPricingContent" rows="10" cols="15" style="width: 97%;"></textarea>
