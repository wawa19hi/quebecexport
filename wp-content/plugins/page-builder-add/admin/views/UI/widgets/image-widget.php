            ...
            <div id="imgWidgetTab1" class="pluginops-tab2 active">
                ...
                <div class="PB_accordion" style="margin-left: -10px;">
                    ...
                    <div>
                        ...
                        <input id="image_location1" type="text" class=" imgUrl ftr-img upload_image_button2" name='lpp_add_img_1' value=' ' placeholder='Insert Image URL here' data-optname="imgUrl" />
                        <label></label>
