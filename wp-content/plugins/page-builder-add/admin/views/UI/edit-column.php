    ...
    <div class="edit_options_left_row">
      <div class="pluginops-tabs2 colEditTabs">
        <ul class="pluginops-tab2-links" style="background: #2fa8f9;">
          ...
          <li style="margin: 0;"><a style="font-size:12px; padding: 10px; text-align: center;" href="#tabColumnWidgetArea" class="pluginops-tab2_link thisColumnWidgetsTab"> <i class="fa fa-puzzle-piece" style="font-size: 20px;"></i> <br> Column Widgets</a></li>
        </ul>
