...
function renderFormBuilderFieldsList(formFieldsArray,mcSavedGroups){
            ...
            jQuery.each(formFieldsArray,function(index, val){
                    ...
                    fbFieldTypetext = ''; fbFieldTypetext = ''; fbFieldTypetel = ''; fbFieldTypeemail = ''; fbFieldTypenumber = ''; fbFieldTypeurl = ''; fbFieldTypedate = ''; fbFieldTypetime = ''; fbFieldTypetextarea = ''; fbFieldTyperadio = ''; fbFieldTypecheckbox = ''; fbFieldTypehidden = ''; fbFieldTypehtml = ''; fbFieldTypemcgroups = ''; fbFieldTypeselect = '';
