...
$('.confirm_template_yes').on('click', function(){
	   ...
	   if (isConfirmTrue_c == true) {
	   	...
	   	switch (popb_selected_template){
	   		...
	   		break;
	   		case 'temp2':
	   		var pageOptions = '{"loadWpHead":"false","loadWpFooter":"false","pageBgImage":"","pageBgColor":" ","pageLink":"'+pageLink+'","pagePadding":{"pagePaddingTop":"0","pagePaddingBottom":"0","pagePaddingLeft":"0","pagePaddingRight":"0"},"pageSeoName":"'+pageSeoName+'","pageSeoDescription":"","pageSeoKeywords":""}';
	   		break;
	   		case 'temp3':
	   		var pageOptions = '{"loadWpHead":"false","loadWpFooter":"false","pageBgImage":"","pageBgColor":" ","pageLink":"'+pageLink+'","pagePadding":{"pagePaddingTop":"0","pagePaddingBottom":"0","pagePaddingLeft":"0","pagePaddingRight":"0"},"pageSeoName":"'+pageSeoName+'","pageSeoDescription":"","pageSeoKeywords":""}';
	   		break;
	   		...
	   		break;
	   		case 'temp21':
	   		var pageOptions = '{"loadWpHead":"false","loadWpFooter":"false","pageBgImage":"https://smuzthemes.com/wp-content/uploads/2017/07/stock-0001.jpg","pageBgColor":" ","pageLink":"'+pageLink+'","pagePadding":{"pagePaddingTop":"0","pagePaddingBottom":"0","pagePaddingLeft":"0","pagePaddingRight":"0"},"pageSeoName":"'+pageSeoName+'","pageSeoDescription":"","pageSeoKeywords":""}';
	   		break;
	   		case 'temp22':
	   		var pageOptions = '{"loadWpHead":"false","loadWpFooter":"false","pageBgImage":"","pageBgColor":" ","pageLink":"'+pageLink+'","pagePadding":{"pagePaddingTop":"0","pagePaddingBottom":"0","pagePaddingLeft":"0","pagePaddingRight":"0"},"pageSeoName":"'+pageSeoName+'","pageSeoDescription":"","pageSeoKeywords":""}';
	   		break;
	   		...
	   		break;
	   		case 'temp26':
	   			var pageOptions = '{"loadWpHead":"false","loadWpFooter":"false","pageBgImage":"https://images.unsplash.com/photo-1503945438517-f65904a52ce6?dpr=1&auto=compress,format&fit=crop&w=1950&h=&q=80&cs=tinysrgb&crop=","pageBgColor":" ","pageLink":"'+pageLink+'","pagePadding":{"pagePaddingTop":"0","pagePaddingBottom":"0","pagePaddingLeft":"0","pagePaddingRight":"0"},"pageSeoName":"'+pageSeoName+'","pageSeoDescription":"","pageSeoKeywords":""}';
	   		break;
	   		case 'temp34':
	   	...
	   	try {
	   		...
	   		getTemplateRequestURL = adminAjaxUrl + '?action=popb_get_template&submitNonce='+POPB_data_nonce+'&templateID='+popb_selected_template;
