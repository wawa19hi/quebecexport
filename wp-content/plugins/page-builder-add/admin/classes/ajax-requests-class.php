...
function ulpb_settings_page_ajax(){
	...
	if ( ! wp_verify_nonce( $plugOps_pageBuilder_settings_nonce, 'POPB_settings_nonce' ) ) {
		...
		if ($ulpb_setting_optionTwo == true || $ulpb_setting_optionOne == true || $ulpb_setting_optionThree == true || $ulpb_setting_optionFour == true  || $ulpb_setting_optionFive == true || $ulpb_setting_optionSix == true ) {
...
function popb_get_row_blocks(){
	...
	if ( ! wp_verify_nonce( $POPB_data_Nonce, 'POPB_data_nonce' ) ) {
		...
		$url = "https://library.pluginops.com/library/blocks/rowBlocks/".$selectedRowBlock.".json";
...
function popb_get_template(){
	...
	if ( ! wp_verify_nonce( $POPB_data_Nonce, 'POPB_data_nonce' ) ) {
		...
		$url = "https://library.pluginops.com/library/templates/".$selectedBlock.".json";
