	...
	class mts_related_posts_widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( __('%sRelated Posts', 'bridge' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
				array( 'description' => __( 'Display the related posts from current post\'s categories. Will appear on single posts only.', 'bridge' ) )
			);
		}
		...
		public function form( $instance ) {
			...
			$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Related Posts', 'bridge' );
			...
			<p>
				<label for="<?php echo $this->get_field_id("comment_num"); ?>">
					...
					<?php _e( 'Show number of comments', 'bridge' ); ?></p>
				</label>
			</p>
