...
if( ! class_exists( 'mts_ad_300_widget' ) ){
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __('A widget for 300 x 250 ad (Single banner)', 'bridge' )
		);
		...
		// Create the widget
		parent::__construct( 'mts_ad_300_widget', sprintf( __('%s300x250 Ad', 'bridge' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad' ); ?>"><?php _e('Ad image url:', 'bridge' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e('Ad link url:', 'bridge' ) ?></label>
