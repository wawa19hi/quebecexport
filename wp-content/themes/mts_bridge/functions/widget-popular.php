	...
	class mts_popular_posts_widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( __('%sPopular Posts', 'bridge' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
				array( 'description' => __( 'Displays most Popular Posts with Thumbnail.', 'bridge' ) )
			);
		}
	 	...
	 	public function form( $instance ) {
			...
			$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'What\'s Hot' , 'bridge' );
			...
			<p>
			   <label for="<?php echo $this->get_field_id( 'days' ); ?>"><?php _e( 'Popular limit (days):', 'bridge' ); ?>
