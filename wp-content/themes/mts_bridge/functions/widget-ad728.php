...
if( ! class_exists( 'mts_ad_728_widget' ) ){
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __('A widget for 728 x 90 ad (Single banner)', 'bridge' )
		);
		...
		// Create the widget
		parent::__construct( 'mts_ad_728_widget', sprintf( __('%s728x90 Ad', 'bridge' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ), $widget_ops, $control_ops );
