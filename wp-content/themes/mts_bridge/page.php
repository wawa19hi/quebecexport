					...
					<div id="post-<?php the_ID(); ?>" <?php post_class('g post'); ?>>
						<div class="single_page">
							...
							<div class="post-content box mark-links entry-content">
								<?php if (!empty($mts_options['mts_social_buttons_on_pages']) && isset($mts_options['mts_social_button_position']) && ($mts_options['mts_social_button_position'] == 'top' || $mts_options['mts_social_button_position'] == 'top_and_bottom')) mts_social_buttons(); ?>
