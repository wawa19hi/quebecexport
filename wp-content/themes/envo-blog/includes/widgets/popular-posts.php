 ...
 * @package PT_Magazine
 */
if ( !class_exists( 'envo_blog_Popular_Posts' ) ) :
	 ...
	 * @since 1.0.0
	 */
	class envo_blog_Popular_Posts extends WP_Widget {

		function __construct() {
			$opts = array(
				'classname'		 => 'popular-posts widget_popular_posts',
				'description'	 => esc_html__( 'Displays your popular posts with thumbnail and date. Recommended use: in sidebar or footer', 'envo-blog' ),
			);

			parent::__construct( 'envo-blog-popular-posts', esc_html__( 'Envo Blog: Popular Posts', 'envo-blog' ), $opts );
		}
		...
		function widget( $args, $instance ) {
			...
			function form( $instance ) {
				...
				$instance = wp_parse_args( (array) $instance, array(
					'title'			 => esc_html__( 'Popular posts', 'envo-blog' ),
					'post_number'	 => 5,
				) );
				?>
				<p>
