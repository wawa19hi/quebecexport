...
if( ! class_exists( 'Builders_Landing_Page_Control_Repeater' ) ) {
    /**
     * Repeater control
     */
    class Builders_Landing_Page_Control_Repeater extends WP_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array() ) {
            ...
            $this->row_label = array(
                'type' => 'text',
                'value' => esc_attr__( 'row', 'builders-landing-page' ),
                'field' => false,
            );
            ...
            if ( empty( $this->button_label ) ) {
                $this->button_label = sprintf( esc_attr__( 'Add new %s', 'builders-landing-page' ), $this->row_label['value'] );
            }
        ...
        protected function render_content() {
            ...
            <?php if ( isset( $this->choices['limit'] ) ) : ?>
                <p class="limit"><?php printf( esc_attr__( 'Limit: %s rows', 'builders-landing-page' ), esc_html( $this->choices['limit'] ) ); ?></p>
            <?php endif; ?>
                                ...
                                <# } else if ( 'color' === field.type ) { #>
                                    ...
                                    <label>
                                        ...
                                        <# if ( field.description ) { #>
                                            <span class="description customize-control-description">{{{ field.description }}}</span>
                                        <# } #>
                                        <input class="color-picker-hex" type="text" maxlength="7" placeholder="<?php echo esc_attr__( 'Hex Value', 'builders-landing-page' ); ?>"  value="{{{ field.default }}}" data-field="{{{ field.id }}}" {{ defaultValue }} />
